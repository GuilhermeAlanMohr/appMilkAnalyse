...
import 'package:appmilkanalyse/service/user_service.dart';
                    ...
                    Container(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () async {
                          ...
                          bool loginCorrected = await UserService().login(email: email, senha: password);
                          if (email != '' && password != '' && loginCorrected) {
